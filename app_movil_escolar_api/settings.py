...
DEBUG = os.environ.get("RENDER") != "true" # en desarrollo
...
# Base de datos: usa MySQL en local, PostgreSQL en Render
if os.environ.get("RENDER", None) == "true":
    # Configuración especial para Render (PostgreSQL)
    DATABASES = {
    ...
    # Configuración local (tu MySQL de XAMPP)
    DATABASES = {
        'default': {
